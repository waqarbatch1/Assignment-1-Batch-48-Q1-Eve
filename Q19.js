...
updated_list.pop();
console.log(updated_list);
var message_to_Aali = "Congrats, Ali you are still invited to the dinner";
var message_to_Aadii = "Congrats, ADEENA you are still invited to the dinner";
...
console.log(updated_list);
console.log("\n");
console.log("I am inviting " + updated_list.length + " people to dinner");
